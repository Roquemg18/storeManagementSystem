...
/**
 * Tipo de Excepción para indicar problemas con los límites de Estructuras lineales.
 * De momento, será uno solo para todos los problemas juntos.
 */
public class PosicionFueraDeLugarException extends RuntimeException {
    /**
     ...
     */
    public PosicionFueraDeLugarException(Throwable razon) {
        super(razon);
    }
     ...
     */
    public PosicionFueraDeLugarException(String mensaje) {
        super(mensaje);
    }
     ...
     */
    public PosicionFueraDeLugarException(String mensaje, Throwable razon) {
        super(mensaje, razon);
    }
}
